...
func (status *ResourceGroupStatus) ConvertToARM(resolvedReferences genruntime.ResolvedReferences) (interface{}, error) {
	if status == nil {
		return nil, nil
	}
	...
	if status.Properties != nil {
		properties, err := status.Properties.ConvertToARM(resolvedReferences)
		if err != nil {
			return nil, err
		}
...
// ConvertToArm converts from a Kubernetes CRD object to an ARM object
func (p *ResourceGroupStatusProperties) ConvertToARM(resolvedReferences genruntime.ResolvedReferences) (interface{}, error) {
	if p == nil {
		return nil, nil
	}
...
// ConvertToArm converts from a Kubernetes CRD object to an ARM object
func (spec *ResourceGroupSpec) ConvertToARM(resolvedReferences genruntime.ResolvedReferences) (interface{}, error) {
	if spec == nil {
		return nil, nil
	}
	...
	result.Name = resolvedReferences.Self()
