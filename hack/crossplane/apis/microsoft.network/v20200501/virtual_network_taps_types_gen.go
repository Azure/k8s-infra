...
type VirtualNetworkTaps struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`
	Spec              VirtualNetworkTaps_Spec  `json:"spec,omitempty"`
	Status            VirtualNetworkTap_Status `json:"status,omitempty"`
}

// +kubebuilder:object:root=true
type VirtualNetworkTapsList struct {
	metav1.TypeMeta `json:",inline"`
...
type VirtualNetworkTap_Status struct {
	...
	Properties *VirtualNetworkTapPropertiesFormat_Status `json:"properties,omitempty"`
...
type VirtualNetworkTapsParameters struct {
	...
	// +kubebuilder:validation:Required
	//Properties: Virtual Network Tap Properties.
	Properties VirtualNetworkTapPropertiesFormat `json:"properties"`
...
//Generated from: https://schema.management.azure.com/schemas/2020-05-01/Microsoft.Network.json#/definitions/VirtualNetworkTapPropertiesFormat
...
const VirtualNetworkTapsSpecApiVersion20200501 = VirtualNetworkTapsSpecApiVersion("2020-05-01")
...
func init() {
	SchemeBuilder.Register(&VirtualNetworkTaps{}, &VirtualNetworkTapsList{})
}
