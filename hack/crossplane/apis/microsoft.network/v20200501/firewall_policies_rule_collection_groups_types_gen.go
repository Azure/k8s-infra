...
type FirewallPoliciesRuleCollectionGroupsParameters struct {
	...
	FirewallPoliciesName         string              `json:"firewallPoliciesName"`
	FirewallPoliciesNameRef      *v1alpha1.Reference `json:"firewallPoliciesNameRef,omitempty"`
	FirewallPoliciesNameSelector *v1alpha1.Selector  `json:"firewallPoliciesNameSelector,omitempty"`
