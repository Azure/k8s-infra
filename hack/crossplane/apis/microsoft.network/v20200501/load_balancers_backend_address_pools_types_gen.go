...
type LoadBalancersBackendAddressPoolsParameters struct {
	...
	LoadBalancersName         string              `json:"loadBalancersName"`
	LoadBalancersNameRef      *v1alpha1.Reference `json:"loadBalancersNameRef,omitempty"`
	LoadBalancersNameSelector *v1alpha1.Selector  `json:"loadBalancersNameSelector,omitempty"`
