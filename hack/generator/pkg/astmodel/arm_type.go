...
func (at *ArmType) AsDeclarations(codeGenerationContext *CodeGenerationContext, declContext DeclarationContext) []ast.Decl {
	return at.objectType.AsDeclarations(codeGenerationContext, declContext)
}
