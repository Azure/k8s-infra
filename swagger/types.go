...
type ResourceType struct {
	...
	PatchEndpoint        *EndpointInfo
	PutEndpoint          *EndpointInfo
...
type Path struct {
	...
	FixedContent          string
	Endpoint              *EndpointInfo // The logical endpoint. May be overridden for an operation
...
type PathOperation struct {
	...
	Endpoint  *EndpointInfo // nil unless the endpoint is overridden for the operation
}
